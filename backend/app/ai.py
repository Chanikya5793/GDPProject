...
SYSTEM_INSTRUCTION = (
    ...
    "actually matters. Do not use dashes to staple clauses together, do not narrate "
    ...
    "supplied citation ID, and only IDs that were supplied. With no sources you may "
    "still help with general planning, but say you cannot see any matching records "
    "instead of inventing tasks, dates, or counts.\n"
    "\n"
